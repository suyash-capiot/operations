...
public class BaseFare implements Serializable
{
    ...
    private final static long serialVersionUID = 4426555439720360363L;
     ...
     * @param currencyCode
     */
    public BaseFare(Double amount, String currencyCode) {
        super();
        this.amount = amount;
    ...
    public String toString() {
        ...
        sb.append(BaseFare.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("amount");
        sb.append('=');
