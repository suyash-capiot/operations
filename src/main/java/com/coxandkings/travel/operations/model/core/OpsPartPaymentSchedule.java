...
public class OpsPartPaymentSchedule {
    ...
    public OpsPartPaymentSchedule() {
    }

    public OpsPartPaymentSchedule(String paymentScheduleType, BigDecimal dueAmount, String dueDate, Boolean isRefundable) {
