...
import com.coxandkings.travel.operations.service.productsharing.CancelRoomService;
...
@Service("cancelRoomService")
public class CancelRoomServiceImpl implements CancelRoomService {
    ...
    public JSONArray getAccoInfo(OpsProduct opsProduct) {
        try {
            ...
            for (OpsRoom opsRoom : rooms) {
                ...
                accomodationInfo.put("modificationType", "CANCELROOM");
...
// todo set Document info
     ...
     */
    @Override
    public Object processRoomCancellation(OpsBooking opsBooking, OpsProduct opsProduct) throws OperationException {
        ...
        try {
            ResponseEntity<?> exchange = restTemplate.exchange(accoCancellationURL, HttpMethod.POST, request, Object.class);
