...
@Service("addPaxService")
public class AddPaxServiceImpl implements AddPaxService {

    @Value(value = "${product_sharing.be.acco_modify}")
    private String addPaxDetailsURL;
...
// todo set Document info
    ...
    public JSONArray getAccoInfo(OpsProduct opsProduct) {
        try {
            ...
            for (OpsRoom opsRoom : rooms) {
                ...
                accomodationInfo.put("accomodationSubType", opsRoom.getRoomTypeInfo().getRoomTypeName());
                ...
                accomodationInfo.put("modificationType", "ADDPASSENGER");
    ...
    public JSONObject getCompleteJsonForAccoCancellation(JSONObject requestHeader, JSONArray accomodationInfo) {
        try {
            ...
            requestBody.put("accomodationInfo", accomodationInfo);
     ...
     */
    @Override
    public Object addPaxDetails(OpsBooking opsBooking, OpsProduct opsProduct, OpsRoom opsRoom, OpsAccommodationPaxInfo opsAccommodationPaxInfo) throws OperationException {
        ...
        try {
            ResponseEntity<?> exchange = restTemplate.exchange(addPaxDetailsURL, HttpMethod.POST, request, Object.class);
