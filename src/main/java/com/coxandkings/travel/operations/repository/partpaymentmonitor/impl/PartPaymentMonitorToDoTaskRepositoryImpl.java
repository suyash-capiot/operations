package com.coxandkings.travel.operations.repository.partpaymentmonitor.impl;
...
@Repository
public class PartPaymentMonitorToDoTaskRepositoryImpl extends SimpleJpaRepository<ToDoTask, String> implements PartPaymentMonitorToDoTaskRepository {

    private EntityManager entityManager;

    public PartPaymentMonitorToDoTaskRepositoryImpl(@Qualifier("opsEntityManager") EntityManager em )   {
